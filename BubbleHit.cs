...
{
    public class BubbleHit : Control
    {
        //Объекты
        ...
        protected virtual void ClearBalls_Array()
        {
            for (int i = 0; i < _BoxHeight; i++)
            {
                for (int j = 0; j < _BoxWidth; j++)
        ...
        protected virtual void SetStartGameValues()
        {
        ...
        protected virtual void ResetScore() { _score = 0; DoScoreChanged(); }

        //Метод задаёт каждому шарику в массиве случайных цвет из набора цветов
        protected virtual void MixBalls()
        {
        ...
        protected virtual void CreatePlayBall()
        {
        ...
        protected virtual bool CheckOnMultipleRow()
        {
        ...
        protected virtual bool CheckOnNeedStopPlayBall(int row)
        {
        ...
        protected virtual void StopPlayBall(int row)
        {
        ...
        protected virtual bool CheckOnDefeat()
        {
        ...
        protected virtual void HandlerDestroyBalls(int x, int y, Color playBallColor)
        {
        ...
        protected virtual void HandlerSameColorBalls(int x, int y, Color playBallColor)
        {
            //Вызов этого метода тут - костыль для цикла for. При цикле do while будет другой костыль - проверка, что список не пустой, По этому особой разници нет
        ...
        protected virtual void CheckNearbyBalls(int x, int y, Color playBallColor)
        {
            Ball ball;
        ...
        protected virtual void DestroyBalls()
        {
            Ball ball;
        ...
        protected virtual void HandlerIslands()
        {
            Ball ball;
        ...
        protected virtual void HandlerGameComplete()
        {
        ...
        protected virtual bool CheckOnEmptyPlayField()
        {
        ...
        protected virtual bool CheckOnOneBallIsIsland(int x, int y)
        {
        ...
        protected virtual bool CheckOnHasGround(int x, int y)
        {
        ...
        protected virtual void CreateWave(int x, int y)
        {
            int level = 1;
        ...
        protected virtual bool CheckOnHaveExtrimWaveCells()
        {
            for (int j = 0; j < _BoxWidth; j++)
            {
        ...
        protected virtual void SetColor(int x, int y, Color ball)
        {
        ...
        protected virtual Color GetRandomColor(int quantityColors)
        {
            UpdateStoreColors();
